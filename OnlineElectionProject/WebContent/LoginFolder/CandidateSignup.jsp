...
<html >
  <head>
    <meta charset="UTF-8">
    <title>Candidate Signup Form</title>
...
textarea:focus { box-shadow: inset 0 -5px 45px rgba(100,100,100,0.4), 0 1px 1px rgba(255,255,255,0.2); }
    	...
    	function validate(cSignup){
    		//alert("Validate called");
    		
    		error_string="The registration cannot proceed due to following -:\n\n";
    		...
    		if(db==true){
    			...
    			alert("You must be 25 years old to be a candidate.");
    			return false;
    		}
    	}
    	
    	function validateMobile(){
    		var mobile = cSignup.mobile.value;
    		if(mobile.length!=10 || isNaN(mobile)){
    			error_string+="Mobile number must be valid\n";
    			return false;
    		}
    	...
    	function validateGender(){
    		var gender = cSignup.gender.value.toUpperCase();
    	...
    	function validateFirstName(){
    		var firstName = cSignup.firstName.value;
    	...
    	function validateLastName(){
    		var lastName = cSignup.lastName.value;
    	...
    	function validateAdhaarNumber(){
    		var adhaarNumber = cSignup.adhaarNumber.value;
  ...
  <body link="white" alink="white" vlink="white">
	...
	<div class="login">
		...
		<form method="post" enctype="multipart/form-data" name="cSignup" onSubmit="return validate()" action="../CandidateServlet">
    		...
    		<input type="text" name="dob" value="" placeholder="Date Of Birth (DD/MM/YYYY)" required="required" />
    		<input type="text" name="gender" placeholder="Gender (Male/Female/Other)" value="" required="required" />
    		<textarea rows="2" name="residentialAddress" placeholder="Residential Address" required="required"></textarea>
    		<textarea rows="2" name="workAddress" placeholder="Work Address" required="required"></textarea>
        	<input type="email" name="email" value="" placeholder="Email" required="required" />
        	<input type="number" name="mobile" placeholder="Mobile Number" value=""  required="required" />
        	<input type="number" name="adhaarNumber" placeholder="Adhaar Card Number (Without space)" value=""  required="required" />
        	<textarea rows="3" name="messageVoters" placeholder="Message For Voters" required="required"></textarea>
        	<font color="white">Upload Adhaar Card</font>
        	<input type="file" name="adhaarCard">
